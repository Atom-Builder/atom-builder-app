...
function OrbitLine({ radius, electronColor }: OrbitLineProps) {
    ...
    const line = useMemo(() => {
        ...
        // Important: Dispose of old geometry and material when component unmounts or props change
        // R3F handles some disposal, but explicit disposal is safer for raw THREE objects
        geometry.dispose();
        material.dispose();
    ...
    return <primitive object={line} dispose={null} />; // Let useMemo handle disposal logic via dependencies
    // --- END CORRECTION ---
}
