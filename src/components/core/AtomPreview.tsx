...
import { Canvas, useFrame } from '@react-three/fiber'; // Removed unused ThreeElements
import { OrbitControls, Sphere } from '@react-three/drei'; // Removed unused Points, PointMaterial
...
function OrbitLine({ radius, electronColor }: OrbitLineProps) {
    // --- FIX Starts Here ---
    // Create the THREE objects explicitly, identical to AtomPreview fix
    const line = useMemo(() => {
        const points = [];
        const segments = 64;
